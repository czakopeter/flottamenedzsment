...
INSERT INTO Sub_note (note, sub_id, begin_date) VALUES ('Sub note', 1, to_date('20-01-01', 'RR-MM-DD'))
...
INSERT INTO Devices (serial_number, type_id, create_date, first_available_date) VALUES ('MZ00123456B', 1, to_date('20-01-01', 'RR-MM-DD'), to_date('20-01-10', 'RR-MM-DD'))
INSERT INTO Sub_dev_st (sub_id, dev_id, begin_date) VALUES (null, 1, to_date('20-01-01', 'RR-MM-DD'))
INSERT INTO Dev_note (note, dev_id, begin_date) VALUES ('Dev note', 1, to_date('20-01-01', 'RR-MM-DD'))
...
INSERT INTO Charge_ratio_by_category (name, available) VALUES ('Default', true)
